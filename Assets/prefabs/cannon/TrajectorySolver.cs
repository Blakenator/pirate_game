...
public class TrajectorySolver
{
    ...
    public static int SolveBallistic(Vector3 proj_pos, float proj_speed, Vector3 target_pos, Vector3 target_velocity, float gravity, out Vector3 s0, out Vector3 s1)
    {
