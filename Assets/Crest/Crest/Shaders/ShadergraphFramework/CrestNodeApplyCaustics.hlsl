...
)
{
	...
	// Scale the light intensity to an appropriate magnitude (10,000 becomes 1). This seems closest to what we had before.
	half3 causticsStrength = lerp(i_strength * i_lightCol * 0.0001, 0.0, saturate(1.0 - exp(-i_depthFogDensity.xyz * sceneDepth)));
