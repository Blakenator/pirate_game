...
namespace Crest
{
    ...
    public class LodDataMgrShadow : LodDataMgr
    {
        ...
        public override void Start()
        {
            ...
            Debug.Assert(false, "Shadowing not supported because render features not enabled. Disable shadowing.", OceanRenderer.Instance);
            ...
            // TODO - sample shadows feature not created yet. Could not see from a quick scan how to add render features?
